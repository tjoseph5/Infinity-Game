...
public class BouncePad : MonoBehaviour
{
    ...
    PlayerMovement playerBallV; //Ball's DragShoot Component

    private void Start()
    {
        playerBallV = GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerMovement>(); //Sets variable to Player ball
    }
